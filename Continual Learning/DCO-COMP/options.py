...
parser.add_argument('--cm_topk', type=int, default=1000, metavar='K')
parser.add_argument('--mlp_saved_epochs', type=int, default=10, metavar='S')

parser.add_argument('--cm_epochs', type=int, default=100, metavar='N')
...
parser.add_argument('--ae_weight_decay', type=float, default= 0.0, metavar='AEWD')
