...
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 1  --cl_epochs 1  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'to_fashion_mnist' --rank 0 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 2  --cl_epochs 2  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'to_fashion_mnist' --rank 1 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 5  --cl_epochs 5  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'to_fashion_mnist' --rank 2 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 10 --cl_epochs 10 --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'to_fashion_mnist' --rank 3 &
wait
...
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 1  --cl_epochs 1  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'from_fashion_mnist' --rank 0 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 2  --cl_epochs 2  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'from_fashion_mnist' --rank 1 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 5  --cl_epochs 5  --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'from_fashion_mnist' --rank 2 &
python main_fashion_mnist.py --main_optimizer 'sgd' --lr_epochs 10 --cl_epochs 10 --num_tasks 2 --main_online_lr 1e-3 --train-batch-size 128 --cl_method 'agem' --episodic_batch_size 256 --episodic_mem_size 256 --cl_dataset 'from_fashion_mnist' --rank 3 &
wait
